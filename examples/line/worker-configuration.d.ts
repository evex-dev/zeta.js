/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 2de874afbfb092eab7e0b38b20711347)
...
interface __BaseEnv_CloudflareBindings {
	...
	ZETA_STATE: DurableObjectNamespace<import("./src/index").ZetaState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ZetaState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CHANNEL_ACCESS_TOKEN" | "CHANNEL_ID" | "CHANNEL_SECRET" | "ZETA_INIT_SECRET">> {}
}
